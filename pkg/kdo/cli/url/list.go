...
// URLListOptions encapsulates the options for the kdo url list command
...
// Run contains the logic for the kdo url list command
...
// NewCmdURLList implements the kdo url list command.
